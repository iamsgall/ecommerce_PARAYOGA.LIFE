...
const BolsosProducts = dynamic(
  () => import('../components/pageProducts/BolsosProducts.jsx'),
  {ssr: false}
);
    ...
    >
      <div className='container'>
        ...
        <p className='p-intro'>
          ...
          <p className='p-intro'>
            Las carteras para gimnasio te permiten llevar más objetos encimas de
            los que imaginas. <b>¿Seguro?</b> ¿te preguntarás?. La respuesta es
            Sí; y muchas. Estos bolsos además de contar por supuesto con el
