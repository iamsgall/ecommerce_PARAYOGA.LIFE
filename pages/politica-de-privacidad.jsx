    ...
    <Layout>
      <main>
        <header className='d-flex justify-content-center mt-4 mb-3'>
          <h1 className='h1-title text-center'>Política de Privacidad</h1>
        </header>
        <div className='d-flex justify-content-center'>
          <div className='col-12'>
            <p>
              La presente Política de Privacidad establece los términos en que
              PARAYOGA.LIFE usa y protege la información que es proporcionada
              ...
              y enfatizamos revisar continuamente esta página para asegurarse
            ...
            <section>
              ...
              <p>
                PARAYOGA.LIFE está altamente comprometido para cumplir con el
            ...
            <section>
              ...
              <p>
                ...
                directamente, . Usted puede aceptar o negar el uso de cookies,
            ...
            <section>
              ...
              <p>
                ...
                pudieran ser de su interés. Una vez que usted hace clic en estos
                enlaces y abandona nuestra página, ya no tenemos control sobre
                al sitio al que es redirigido y por lo tanto no somos
                responsables de los términos o privacidad ni de la protección de
                sus datos en esos otros sitios de terceros. Dichos sitios están
            ...
            <section>
              ...
              <p>
                PARAYOGA.LIFE Se reserva el derecho de cambiar los términos de
